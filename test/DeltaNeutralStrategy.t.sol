...
contract MockHedgingPlatform is IHedgingPlatform {
    ...
    function openShortPosition(
        ...
        uint256 amount,
        uint256 maxSlippage
    ) external returns (uint256 positionId, uint256 executedAmount) {
    ...
    function closeShortPosition(
        ...
        uint256 amount,
        uint256 maxSlippage
    ) external returns (uint256 closedAmount, int256 pnl) {
...
contract DeltaNeutralStrategyTest is Test {
    ...
    function testFullStrategyFlow() public {
        ...
        (
            ...
            int256 ethExposureBefore,
            int256 btcExposureBefore,
            int256 usdExposureBefore
        ) = strategy.getPortfolioSummary();
        ...
        (
            ...
            int256 ethExposureAfter,
            int256 btcExposureAfter,
            int256 usdExposureAfter
        ) = strategy.getPortfolioSummary();
